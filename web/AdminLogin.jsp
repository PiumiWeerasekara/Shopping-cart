<%-- 
Document   : AdminLogin
Created on : Jun 15, 2018, 5:18:38 AM
Author     : DEll
--%>
    ...
    <body>
        <form action="AdminController" method="POST">
            <div class="a">
                ...
                <br>
                <div>
                    <button type="submit" name="action" class="log" formaction="AdminController">Login</button>
                    <a href="AdminLogin.jsp" class="cancel" >Cancel</a>
                    <br>
