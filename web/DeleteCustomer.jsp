<%-- 
    ...
    Created on : Jun 16, 2018, 2:13:40 AM
    Author     : DEll
--%>
        ...
        <div class="a">
            ...
            <div class="c">
                ...
                <div class="form-group row">
                    ...
                    <button type="submit" class="delete" name="action" formaction="DeleteCustomerController">Delete</button>
                    <a href="DeleteCustomer.jsp" class="cancel" >Cancel</a>
