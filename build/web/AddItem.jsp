<%-- 
    Document   : AddItem
    Created on : Jun 16, 2018, 2:11:37 AM
    Author     : DEll
--%>
        ...
        <form action="AddItemController">
            <div class="a">
                ...
                <div class="c">
                    ...
                    <button type="submit" class="save" name="action" formaction="AddItemController">Save</button>
                    <a href="AddItem.jsp" class="cancel" >Cancel</a>
                </div>
            </div>
        </form>
    </body>
