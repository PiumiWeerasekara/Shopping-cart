...
public class CustomerLoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CustomerService cstomerService=new ServiceFactory().getCustomerService();
            ...
            CustomerDto customerDto=cstomerService.findCustomer(name, password);
            if (null==customerDto) {
                out.print("<script language='JavaScript'>alert('Incorrect userName or password');</script>");
                out.print("<script language='JavaScript'>window.location.replace('CustomerLogin.jsp');</script>");
            
            }else{
                RequestDispatcher dis=request.getRequestDispatcher("CustomerMain.jsp");
