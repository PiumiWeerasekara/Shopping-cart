...
public class ViewItemController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (all.isEmpty()) {
                out.print("<script language='javaScript'>alert('Item List is empty')</script>");
            }
            else{
                request.setAttribute("allItems", all);
                RequestDispatcher dis=request.getRequestDispatcher("ViewAllItems.jsp");
