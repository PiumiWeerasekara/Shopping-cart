...
public class AdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            AdminService adminService=new ServiceFactory().getAdminService();
            ...
            AdminDto adminDto=adminService.findAdmin(name, password);
            if (null==adminDto) {
                out.print("<script language='JavaScript'>alert('Incorrect userName or password');</script>");
                out.print("<script language='JavaScript'>window.location.replace('AdminLogin.jsp');</script>");
